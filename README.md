...
สายอนุมัติแยกคน: **ผู้ขอ → หัวหน้าบัญชี/ผู้บริหาร → ผู้บันทึกจ่าย**
...
| 15 | [แยกบทบาทหัวหน้าบัญชี · เชื่อมกับแอปตรวจรับของ QC](docs/15-roles-and-qc-app.md) | **7 บทบาท — ผู้ขอ ผู้อนุมัติ ผู้บันทึกจ่าย เป็นคนละคนกัน** พร้อมกฎบังคับ · และหลักที่ว่า **ที่ไหนมีระบบอยู่แล้วให้ผูกไป ไม่ใช่ทำใหม่** — QC ตรวจในแอป Incoming Inspection เดิม ระบบนี้ผูกด้วยเลขที่ใบตรวจ |
