...
node tools/smoke.js         # ชุดทดสอบ 280 การเรนเดอร์ (7 บทบาท) + เคสของทุกฟีเจอร์
