/**
 * ตัวนำเข้าข้อมูล Costing จาก SAP เข้า MGS Document Hub
 * ------------------------------------------------------------------
 * *** นี่ไม่ใช่ระบบที่สอง *** — ระบบมีอันเดียวคือ MGS Document Hub
 * ไฟล์นี้ทำหน้าที่เดียว: อ่านรายงาน Costing ที่ออกจาก SAP แล้วเขียนลงตารางของ Dochub
 * ไม่มีหน้าจอของตัวเอง ไม่มี Dashboard ของตัวเอง คนใช้เห็นผลที่ Dochub ที่เดียว
 *
 ...
 *   Ledger    จดว่าแถวไหนนำเข้า Dochub ไปแล้ว — *ห้ามลบ* ลบแล้วจะตั้งเบิกซ้ำ
 *
...
var CFG = {
  ...
  SHEET_LEDGER: 'Ledger',                  // จดว่าแถวไหนนำเข้า Dochub ไปแล้ว — ห้ามลบ
  KEEP_LOG:     200,                       // เก็บ log กี่บรรทัด
  HUB_URL:      '',                        // ลิงก์ Document Hub · ว่าง = ไม่ทำคอลัมน์ลิงก์
  HUB_ENDPOINT: '',                        // ปลายทางของ Dochub · ว่าง = จดใน Ledger อย่างเดียว ไม่ยิงออก
