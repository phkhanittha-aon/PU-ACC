...
> ⚠️ **เอกสารนี้ถูกปรับปรุงแล้วใน [เอกสาร 06 ทบทวน Scope](06-scope-review.md)**
> — ตัด `Deal_Stages`, `Match_Check`, `Physical_Docs` ออก และเพิ่ม `Claims`, `ItemCode_Requests`
> โครงสร้างล่าสุดคือ 13 ตารางตามเอกสาร 06 ส่วนรายละเอียดคอลัมน์ด้านล่างยังใช้อ้างอิงได้
