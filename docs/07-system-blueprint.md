...
```
Documents.ref_type = PO | CLAIM | ITEM_REQ
Documents.ref_no   = PO-26-0042 | EX-2026001 | IC-26-0007     ← บังคับ ห้ามว่าง
```
...
| 2 | **Lark / LINE** | เฉพาะเรื่องที่**ต้องลงมือ** | ภายใน 1 นาที |
...
sequenceDiagram
  ...
  participant CH as Lark / LINE / Email
...
2. **ช่องทางแจ้งเตือน** — ใช้ Lark อย่างเดียว หรือต้องมี LINE ด้วย (คนละต้นทุนในการดูแล)
